...
TRIVIAL_PROMPT_RE = re.compile(
    ...
    # Everyday whole-message replies in voice/chat; still anchored, never a prefix.
    r'好|好吧|嗯+|对|对的|是的|行|可以|没问题|谢谢你|谢谢您|感谢|辛苦了|'
    r'再见|拜拜|晚安|早安|早上好|晚上好|继续|'
    r'こんにちは|こんばんは|おはよう(?:ございます)?|ありがとう(?:ございます)?|'
    r'了解(?:しました)?|承知しました|はい|いいえ|'
    r'うん|ええ|そうです(?:ね)?|(?:わ|分)かりました|(?:よろしく)?お願いします|よろしく|'
    r'おやすみ(?:なさい)?|さようなら|どうも|続けて|オッケー)'
    r'[\s!?.:;,"' + "'" + r'~\u2018\u2019\u201c\u201d\u2014\u2013\u2026()\[\]{}<>*&^%$#@!+=`\u00a0。！？、，：；〜～「」『』（）【】]*$',
    re.IGNORECASE,
)
